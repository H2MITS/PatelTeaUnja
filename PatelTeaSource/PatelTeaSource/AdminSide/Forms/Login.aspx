<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" EnableEventValidation="false" Inherits="PatelTeaSource.AdminSide.Forms.Login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login Page - Patel Tea Packers</title>
                        ...
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header no-border">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with Patel Tea Packers</span></h6>
                                </div>
                                ...
                                <div class="card-body collapse in">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form class="form-horizontal form-simple" action="index.html" novalidate>
                                            ...
                                            <asp:Button ID="btnSubmit" runat="server" class="btn btn-primary btn-lg btn-block" OnClick="btnSubmit_Click" Text="Login" />
